...
import com.test.supper.CacheMessage;
...
/**
 * spring cache中有实现Cache接口的一个抽象类AbstractValueAdaptingCache，包含了空值的包装和缓存值的包装，
 * 所以就不用实现Cache接口了，直接实现AbstractValueAdaptingCache抽象类
 *
 * @author ：Breeze
 * @date ：Created in 2020/11/9 0:03
 * @description：
 */
